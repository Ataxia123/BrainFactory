...
const Home: NextPage = () => {
    ...
    (
        <div
            className={"text-justify items-left p-6 flex flex-row h-800 w-2/3"}
        >
            <div
    ...
    return (
        <div className={"relative top-0 p-12 h-[700px] w-2/3 border-2 -backdrop-hue-rotate-0 flex flex-row"}>
            ...
            <div className={"p-6 space-x-2 bg-black text-white"}>
                ...
                <button onClick={() => embedCall()}> <strong>Embed</strong> </button>
            </div>
        </div>
